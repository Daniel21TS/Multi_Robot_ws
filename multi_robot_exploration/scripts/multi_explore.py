...
#            print("size={}, x={}, y={}".format(size, middle_point.point.x , middle_point.point.y))
    ...
    def compute_density(self, frontier_robot, map_type):
        ...
        for data in frontier_robot:
            ...
            if map_type == 1:
                if size <= 7 and frontier_density <= 0.45:
                    size = 107.51
                    table.append((size, middle_point))
                if size > 7 and size <= 14 and frontier_density <= 0.45:
                    size = 108.89
                    table.append((size, middle_point))
                if size > 14 and frontier_density <= 0.45:
                    size = 128.28
                    table.append((size, middle_point))
                if size <= 7 and frontier_density > 0.45 and frontier_density <= 0.9:
                    size = 118.48 
                    table.append((size, middle_point))
                if size > 7 and size <= 14 and frontier_density > 0.45 and frontier_density <= 0.9:
                    size = 117.73
                    table.append((size, middle_point))
                if size > 14 and frontier_density > 0.45 and frontier_density <= 0.9:
                    size = 145.48
                    table.append((size, middle_point))
                if size <= 7 and frontier_density > 0.9:
                    size = 127.96
                    table.append((size, middle_point))
                if size > 7 and size <= 14 and frontier_density > 0.9:
                    size = 180.62
                    table.append((size, middle_point))
                if size > 14 and frontier_density > 0.9:
                    size = 135.43
                    table.append((size, middle_point))
